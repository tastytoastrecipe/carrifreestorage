...
@property (weak, nonatomic) UILabel  *subtitleLabel02;
...
@property (strong, nonatomic) NSString *subtitle02;
...
@property (strong, nonatomic) UIColor *preferredSubtitle02DefaultColor;
@property (strong, nonatomic) UIColor *preferredSubtitle02SelectionColor;
...
@property (assign, nonatomic) CGPoint preferredSubtitle02Offset;
