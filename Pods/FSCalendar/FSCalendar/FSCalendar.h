...
- (nullable NSString *)calendar:(FSCalendar *)calendar subtitle02ForDate:(NSDate *)date;
...
- (nullable UIColor *)calendar:(FSCalendar *)calendar appearance:(FSCalendarAppearance *)appearance subtitle02DefaultColorForDate:(NSDate *)date;
...
- (nullable UIColor *)calendar:(FSCalendar *)calendar appearance:(FSCalendarAppearance *)appearance subtitle02SelectionColorForDate:(NSDate *)date;
...
- (CGPoint)calendar:(FSCalendar *)calendar appearance:(FSCalendarAppearance *)appearance subtitle02OffsetForDate:(NSDate *)date;
...
@property (assign, nonatomic) IBInspectable CGFloat  subtitle02TextSize;
...
@property (strong, nonatomic) IBInspectable UIColor  *subtitle02DefaultColor;
@property (strong, nonatomic) IBInspectable UIColor  *subtitle02SelectionColor;
@property (strong, nonatomic) IBInspectable UIColor  *subtitle02TodayColor;
@property (strong, nonatomic) IBInspectable UIColor  *subtitle02PlaceholderColor;
@property (strong, nonatomic) IBInspectable UIColor  *subtitle02WeekendColor;
