 ...
 * The offset of the day text from default position.
 */
@property (assign, nonatomic) CGPoint  subtitle02Offset;
...
@property (strong, nonatomic) UIColor  *subtitle02DefaultColor;
...
@property (strong, nonatomic) UIColor  *subtitle02TodayColor;
