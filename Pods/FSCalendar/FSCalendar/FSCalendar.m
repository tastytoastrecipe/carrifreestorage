...
#define FSCalendarInvalidateCellAppearanceWithDefault(SEL1,SEL2,DEFAULT) \
    ...
    if (cell.subtitle02) {
        FSCalendarInvalidateCellAppearance(preferredSubtitle02DefaultColor,subtitle02DefaultColorForDate);
        FSCalendarInvalidateCellAppearance(preferredSubtitle02SelectionColor,subtitle02SelectionColorForDate);
        FSCalendarInvalidateCellAppearanceWithDefault(preferredSubtitle02Offset,subtitle02OffsetForDate,CGPointInfinity);
    }
...
- (void)reloadDataForCell:(FSCalendarCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.subtitle02 = [self.dataSourceProxy calendar:self subtitle02ForDate:date];
